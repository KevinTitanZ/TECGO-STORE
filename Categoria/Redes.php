...
<body>
    ...
    <section class="home">
        ...
        <div class="categories">
            <div class="category">
                <img src="../img/Red1.webp" alt="Redes">
                <span>ROUTER MERCUSYS MW302R MULTI-MODE WIRELES</span>
                <span class="price">$39.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red2.webp" alt="Redes">
                <span>ROUTER MERCUSYS BY TP-LINK N300MBPS WIRELESS</span>
                <span class="price">$29.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red3.webp" alt="Redes">
                <span>ROUTER INALAMBRICO N 300MBPS TL-WR840N</span>
                <span class="price">$34.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red4.webp" alt="Redes">
                <span>ROUTER AC750 DOBLE BANDA 4 ANTENAS ARCHER C24</span>
                <span class="price">$49.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red5.webp" alt="Redes">
                <span>SWITCH MERCUSYS ESCRITORIO 5-PORT</span>
                <span class="price">$19.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red6.webp" alt="Redes">
                <span>SWITCH DE MESA CON 5 PUERTOS GIGABIT TL-SG1005D</span>
                <span class="price">$24.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red7.webp" alt="Redes">
                <span>SWITCH DE MESA CON 8 PUERTOS 10-100-1000MBPS</span>
                <span class="price">$34.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red8.webp" alt="Redes">
                <span>SWITCH GIGABIT ESCRITORIO 8-PORT 10-100-1000MBPS</span>
                <span class="price">$39.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red9.webp" alt="Redes">
                <span>MFAX MODEM ASROCK HDMR 56.6KB INTERNO</span>
                <span class="price">$14.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red10.webp" alt="Redes">
                <span>ADAPTADOR INALAMBRICO PCI EXPRESS N 150MBPS TL-WN781ND</span>
                <span class="price">$19.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red11.webp" alt="Redes">
                <span>BRAZO ARTICULADO PARA MICROFONO</span>
                <span class="price">$29.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Red12.webp" alt="Redes">
                <span>BRAZO ARTICULADO PARA MICROFONO</span>
                <span class="price">$29.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
