...
<body>
    ...
    <section class="home">
        ...
        <div class="categories">
            <div class="category">
                <img src="../img/Cam1.webp" alt="Periféricos">
                <span>CAM. VID CONF. ARGOM ARG-WC-9120BK 720P</span>
                <span class="price">$49.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam2.webp" alt="Periféricos">
                <span>CAMARA GENIUS FACECAM 1000X V2</span>
                <span class="price">$59.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam3.webp" alt="Periféricos">
                <span>WEBCAM LOGITECH C270 NEGRO USB 1280X720-30FPS</span>
                <span class="price">$69.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam4.webp" alt="Periféricos">
                <span>CAMARA WI-FI FIJA DE SEGURIDAD</span>
                <span class="price">$89.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam5.webp" alt="Periféricos">
                <span>HUB ARGOM AXESS 3 IN 1 TYPE</span>
                <span class="price">$34.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam6.webp" alt="Periféricos">
                <span>CARD READER IMEXX USB</span>
                <span class="price">$24.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam7.webp" alt="Periféricos">
                <span>FLASH MEMORY SANDISK 16GB CRUZER BLADE USB</span>
                <span class="price">$19.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam9.webp" alt="Periféricos">
                <span>FLASH MEMORY SANDISK 32GB CRUZER BLADE USB ROJO</span>
                <span class="price">$29.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam10.webp" alt="Periféricos">
                <span>COBERTOR LG FOR TV 60INC</span>
                <span class="price">$39.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam8.webp" alt="Periféricos">
                <span>FLASH MEMORY SANDISK 16GB CRUZER BLADE USB AZUL</span>
                <span class="price">$21.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam11.webp" alt="Periféricos">
                <span>COBERTOR LG FOR TV 65INC</span>
                <span class="price">$44.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Cam10.webp" alt="Periféricos">
                <span>COBERTOR LG FOR TV 49INC</span>
                <span class="price">$34.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
        </div>
