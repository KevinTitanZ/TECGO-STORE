...
<body>
    ...
    <section class="home">
        ...
        <div class="categories">
            <div class="category">
                <img src="../img/Au1.webp" alt="Audio & Sonido">
                <span>HEADSET CON MICROFONO NEGRO</span>
                <span class="price">$49.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au2.webp" alt="Audio & Sonido">
                <span>HEADSET SENNHEISER HD 450T WHITE</span>
                <span class="price">$129.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au3.webp" alt="Audio & Sonido">
                <span>AUDÍFONOS SAMSUNG-TOUCH</span>
                <span class="price">$79.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au4.webp" alt="Audio & Sonido">
                <span>EARBUDS ARGOM NEGRO</span>
                <span class="price">$39.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au5.webp" alt="Audio & Sonido">
                <span>ALTAVOCES GENIUS SP-HF180</span>
                <span class="price">$89.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au6.webp" alt="Audio & Sonido">
                <span>PARLANTE AMAZON ECHO DOT 5TA GENERACIÓN</span>
                <span class="price">$99.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au7.webp" alt="Audio & Sonido">
                <span>MICRÓFONO EL GATO BY CORSAIR</span>
                <span class="price">$149.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Au8.webp" alt="Audio & Sonido">
                <span>MICRÓFONO LOGITECH EXPANSION</span>
                <span class="price">$79.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
            ...
            <div class="category">
                <img src="../img/Au9.webp" alt="Audio & Sonido">
                <span>BRAZO ARTICULADO PARA MICRÓFONO</span>
