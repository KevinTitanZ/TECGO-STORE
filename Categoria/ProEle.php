...
<body>
    ...
    <section class="home">
        <div class="text">Protección Electrónica</div>
        <div class="categories">
            <div class="category">
                <img src="../img/Prot1.webp" alt="Protección Electrónica">
                <span>UPS CDP R-UPR508 INTERACTIVO 500VA-250W</span>
                <span class="price">$79.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot2.webp" alt="Protección Electrónica">
                <span>UPS CDP R-UPR758 INTERACTIVO 750VA-350W</span>
                <span class="price">$99.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot3.webp" alt="Protección Electrónica">
                <span>UPS CDP R-UPR1008 INTERACTIVO 1000VA-500W</span>
                <span class="price">$129.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot4.webp" alt="Protección Electrónica">
                <span>UPS CDP UPO11-2 ON LINE TORRE 2000VA-1800W</span>
                <span class="price">$199.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot5.webp" alt="Protección Electrónica">
                <span>UPS APC SRV2KA ON LINE 120V 4 TOMAS PANTALLA LCD</span>
                <span class="price">$249.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot6.webp" alt="Protección Electrónica">
                <span>UPS CDP UPO11-3RT ON LINE RACK 3000VA-2700W</span>
                <span class="price">$349.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot7.webp" alt="Protección Electrónica">
                <span>UPS CDP R-SMART751 INTERACTIVO 750VA-375W</span>
                <span class="price">$89.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot8.webp" alt="Protección Electrónica">
                <span>SUPRESOR DE PICOS QUASAD NEMA5-15R 6 OUTLETS</span>
                <span class="price">$34.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot9.webp" alt="Protección Electrónica">
                <span>UPS APC BV500 INTERACTIVO EASY UPS 120V 6 TOMAS</span>
                <span class="price">$119.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot10.webp" alt="Protección Electrónica">
                <span>UPS INTERACTIVO EASY UPS 120V 6 TOMAS</span>
                <span class="price">$109.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot11.webp" alt="Protección Electrónica">
                <span>UPS APC SRV3KA ON LINE 120V EASY UPS PANTALLA LCD</span>
                <span class="price">$299.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Prot12.webp" alt="Protección Electrónica">
                <span>UPS CDP UPO11-3RT ON LINE RACK 3000VA-2700W</span>
