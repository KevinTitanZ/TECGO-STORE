...
<body>
    ...
    <section class="home">
        ...
        <div class="categories">
            <div class="category">
                <img src="../img/Soft1.webp" alt="Software">
                <span>ANTIVIRUS KASPERSKY SAFE KIDS 1Y</span>
                <span class="price">$39.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft2.webp" alt="Software">
                <span>ANTIVIRUS KASPERSKY STANDARD</span>
                <span class="price">$49.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft3.webp" alt="Software">
                <span>ANTIVIRUS KASPERSKY PLUS</span>
                <span class="price">$59.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft4.webp" alt="Software">
                <span>ANTIVIRUS F-SECURE SAFE LICENCIA</span>
                <span class="price">$44.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft5.webp" alt="Software">
                <span>LICENCIA MICROSOFT OFFICE 365 PERSONAL</span>
                <span class="price">$69.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft6.webp" alt="Software">
                <span>WINDOWS 11 PRO 64-BIT EDITION CD-ROM OEM</span>
                <span class="price">$129.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft7.webp" alt="Software">
                <span>MICROSOFT OFFICE HOME AND BUSINESS 2021 ALL LANGUAGES</span>
                <span class="price">$249.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft8.webp" alt="Software">
                <span>WIN PRO GGK 10 64BIT SPANISH LATAM 1PK DSP ORT OEI DVDSON</span>
                <span class="price">$139.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft9.webp" alt="Software">
                <span>WINDOWS SERVER STD 2022 16CORE</span>
                <span class="price">$699.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft10.webp" alt="Software">
                <span>WINDOWS SERVER STD 2022 16CORE SP 64BITS DVD 1PK</span>
                <span class="price">$749.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft11.webp" alt="Software">
                <span>LICENCIA KARAOKE FARRAOKE.COM</span>
                <span class="price">$29.99</span>
                <button class="add-to-cart"><i class='bx bx-cart'></i> Añadir al carrito</button>
            </div>
            <div class="category">
                <img src="../img/Soft12.webp" alt="Software">
                <span>GARANTIA EXTENDIDA 1 YEAR MX711</span>
